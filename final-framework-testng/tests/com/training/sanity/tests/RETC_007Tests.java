...
public class RETC_007Tests {
	...
	public void validRETC_007Test() {
		...
		apartmentPage.enterName("manzoor");
		apartmentPage.enterEmail("manzoor@gmail.com");
		apartmentPage.enterSubject("apartments");
		apartmentPage.enterComments("looking for an apartments");
		apartmentPage.clickSendButton();
		String messageResponse = apartmentPage.getResponseMessage();
